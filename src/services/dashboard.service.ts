...
export const DashboardService = {
  async getAll() {
    const [products, amcPlans, serviceRequests, inquiries, faqs, gallery, siteServices] =
      await Promise.all([
    ...
    return { products, amcPlans, serviceRequests, inquiries, faqs, gallery, siteServices };
  },
