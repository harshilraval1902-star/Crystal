              ...
              <div className="space-y-5">
                <div className="bg-white rounded-2xl border border-blue-100 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    ...
                    <a
                      href="mailto:crystalnaturalwater@gmail.com"
                      className="flex items-center gap-4 p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors group"
                    >
                      <div className="bg-blue-600 text-white p-2.5 rounded-lg group-hover:bg-blue-700 transition-colors">
                      ...
                      <div>
                        ...
                        <div className="font-bold text-gray-900 break-all">crystalnaturalwater@gmail.com</div>
                      </div>
                    </a>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-blue-50 rounded-xl">
                      ...
                      <div>
                        ...
                        <div className="font-bold text-gray-900">India | Established 2019</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-blue-50 rounded-xl">
                      ...
                      <div>
                        ...
                        <div className="font-bold text-gray-900">Mon–Sat: 9 AM – 7 PM</div>
                        <div className="text-sm text-gray-500">Sunday: 10 AM – 4 PM</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-5">
                <div className="bg-white rounded-2xl border border-blue-100 p-6 shadow-sm">
                  ...
                  <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
                    <p>
                      Founded in 2019, Crystal Natural Water is a trusted name in RO Water Purifier sales and service. We specialize in domestic and commercial RO systems, offering complete solutions from installation to annual maintenance.
                    </p>
                    <p>
